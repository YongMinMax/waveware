...
const SkillPage = () => {
  return (
    <div className={`relative    mb-[110px]  min-w-full max-w-full`}>
...
const SkillContainer = ({ className }) => {
  ...
  return (
    <div className={` container flex flex-col items-end px-0 ${className}`}>
      <MoveScrollText entryDuration={0.8} entryTiming={0.1} axis="x" className={`mt-[390px]`}>
...
const IntroText = ({ className }) => {
  ...
  return (
    <div className={`container text-center flex flex-col mt-[150px]  items-center pt-[40px]   ${className}  `}>
      ...
      <div className={` whitespace-pre-line mt-[37px] snap-start`}>
