...
export default function Career() {
  ...
  const processes = {
    1: {
      ...
      title: "지원",
      description:
        "당신의 성장 가능성과 열정을 보여주세요. 우리는 다양한 가능성을 열린 마음으로 바라봅니다.",
      isHighlighted: false,
    },
    2: {
      id: 2,
      ...
      title: "서류 전형",
      description:
        "경험과 가치관을 확인합니다. 지원자의 잠재력과 도전 의지를 중요하게 생각합니다.",
      isHighlighted: false,
    },
    3: {
      id: 3,
    ...
    4: {
      ...
      title: "최종 합격",
      description:
        "우리와 함께할 준비가 되셨나요? 최종합격자는 새로운 여정을 함께할 동료로서 맞이하게 됩니다.",
      isHighlighted: false,
    },
    5: {
      id: 5,
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center">
      <MenuHeader
        title={"Career"}
        description={"사람의 성장이 회사의 성장이라고 믿습니다."}
      />
      ...
      <div className="w-[1300px] h-[500px] flex relative mt-20">
        <div className="absolute left-0">
          <ProcessComponent
            ...
            isActive={
              hoveredProcess === 1 ||
              (hoveredProcess === null && activeProcess === 1)
            }
            onHover={handleHover}
          />
        </div>
        <div className="absolute left-[255px]">
          <ProcessComponent
            ...
            isActive={
              hoveredProcess === 2 ||
              (hoveredProcess === null && activeProcess === 2)
            }
            onHover={handleHover}
          />
        </div>
        <div className="absolute left-[510px]">
          <ProcessComponent
            ...
            isActive={
              hoveredProcess === 3 ||
              (hoveredProcess === null && activeProcess === 3)
            }
            onHover={handleHover}
          />
        </div>
        <div className="absolute left-[765px]">
          <ProcessComponent
            ...
            isActive={
              hoveredProcess === 4 ||
              (hoveredProcess === null && activeProcess === 4)
            }
            onHover={handleHover}
          />
        </div>
        <div className="absolute left-[1020px]">
          <ProcessComponent
            ...
            isActive={
              hoveredProcess === 5 ||
              (hoveredProcess === null && activeProcess === 5)
            }
            onHover={handleHover}
          />
        </div>
