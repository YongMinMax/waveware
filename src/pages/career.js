        ...
        <main className="min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="w-[1300px] h-[500px] flex relative my-20">
                <div className="absolute left-0">
                    <ProcessComponent step={"STEP 1"} title={"지원"}
                                      description={"당신의 성장 가능성과 열정을 보여주세요. 우리는 다양한 가능성을 열린 마음으로 바라봅니다."}
                                      isHighlighted={false}/>
                </div>
                <div className="absolute left-[255px]">
                    <ProcessComponent step={"STEP 2"} title={"서류 전형"}
                                      description={"경험과 가치관을 확인합니다. 지원자의 잠재력과 도전 의지를 중요하게 생각합니다."}
                                      isHighlighted={false}/>
                </div>
                <div className="absolute left-[510px]">
                    <ProcessComponent step={"STEP 3"} title={"면접"} description={"문제 해결에 대한 태도와 협업 역량을 살펴봅니다."}
                                      isHighlighted={false}/>
                </div>
                <div className="absolute left-[765px]">
                    <ProcessComponent step={"STEP 4"} title={"최종 합격"}
                                      description={"우리와 함께할 준비가 되셨나요? 최종합격자는 새로운 여정을 함께할 동료로서 맞이하게 됩니다."}
                                      isHighlighted={true}/>
                </div>
                <div className="absolute left-[1020px]">
                    <ProcessComponent step={"FINAL"} title={"입사"} description={"함께 성장하고, 함께 도전하며 더 나은 내일을 만들어갑니다."}
                                      isHighlighted={false}/>
                </div>
            </div>

            <span className="w-[1400px] pb-4 text-5xl font-bold text-left">Who We Wants</span>
            <section className="w-full h-[600px] bg-gray-100 flex justify-center">
